...
<body class="app-auth-body" data-clear-product-builder-cache="true">
                    ...
                    <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5">
                        <section class="card shadow-sm app-auth-card">
                            <div class="card-body p-4 p-md-5">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="position-relative">
                                        <asp:TextBox ID="PasswordTextBox" runat="server" TextMode="Password"
                                            MaxLength="128" CssClass="form-control pe-5" ClientIDMode="Static"
                                            autocomplete="current-password" />

                                        <button type="button" id="TogglePasswordButton"
                                            class="position-absolute top-50 end-0 translate-middle-y border-0 bg-transparent text-secondary p-2 me-1"
                                            aria-label="הצג סיסמה" aria-pressed="false" title="הצג סיסמה">
                                ...
                                <asp:Button ID="LoginButton" runat="server" Text="התחברות"
                                    CssClass="btn btn-primary w-100" OnClick="LoginButton_Click" />

                                <asp:Label ID="LoginResultLabel" runat="server"
                                    CssClass="d-block text-danger text-center mt-3" role="status" />

                                <div class="text-center mt-4">
                                    <span class="text-secondary">עדיין אין לך חשבון?</span>
                                    <a href="<%: ResolveUrl("~/Register.aspx") %>"
                                        class="btn btn-link p-0 fw-semibold text-decoration-none">הירשם</a>
                                </div>
                            </div>
                        </section>
                    </div>
